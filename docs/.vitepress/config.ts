...
export default defineConfig<EPThemeConfig>({
  ...
  vite: {
    ...
    optimizeDeps: {
      include: ['@formily/core', '@silver-formily/reactive-vue', '@formily/reactive', '@formily/shared', 'lodash-es', '@element-plus/icons-vue', 'vue-draggable-plus', '@silver-formily/grid', 'element-plus', 'dayjs'],
